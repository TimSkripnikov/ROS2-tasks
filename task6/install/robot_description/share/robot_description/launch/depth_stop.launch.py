...
def generate_launch_description():
    ...
    sdf_file = os.path.join(pkg_share, 'src', 'models', 'sensors.sdf')
    ...
    gz_topic = '/model/sensors'
    joint_state_gz_topic = '/world/sensors' + gz_topic + '/joint_state'
    ...
    depth_stopper = Node(
        ...
        executable='depth_camera_stop.py',
        name='depth_stopper',
        output='screen'
    )
