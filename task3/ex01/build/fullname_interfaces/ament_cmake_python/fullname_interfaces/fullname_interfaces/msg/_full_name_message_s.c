...
bool fullname_interfaces__msg__full_name_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fullname_interfaces.msg._full_name_message.FullNameMessage", full_classname_dest, 58) == 0);
  }
  fullname_interfaces__msg__FullNameMessage * ros_message = _ros_message;
  {  // last_name
...
{
  /* NOTE(esteve): Call constructor of FullNameMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fullname_interfaces.msg._full_name_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FullNameMessage");
