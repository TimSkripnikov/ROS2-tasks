...
static const _FullNameMessage_type_support_symbol_names_t _FullNameMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fullname_interfaces, msg, FullNameMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fullname_interfaces, msg, FullNameMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fullname_interfaces, msg, FullNameMessage)() {
  return &::fullname_interfaces::msg::rosidl_typesupport_c::FullNameMessage_message_type_support_handle;
}
