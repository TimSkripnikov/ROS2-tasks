...
{
public:
  explicit Init_FullNameSumService_Event_response(::full_name_interfaces::srv::FullNameSumService_Event & msg)
  : msg_(msg)
  {}
  ::full_name_interfaces::srv::FullNameSumService_Event response(::full_name_interfaces::srv::FullNameSumService_Event::_response_type arg)
  {
...
private:
  ::full_name_interfaces::srv::FullNameSumService_Event msg_;
};

class Init_FullNameSumService_Event_request
{
public:
  explicit Init_FullNameSumService_Event_request(::full_name_interfaces::srv::FullNameSumService_Event & msg)
  : msg_(msg)
  {}
  Init_FullNameSumService_Event_response request(::full_name_interfaces::srv::FullNameSumService_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_FullNameSumService_Event_request info(::full_name_interfaces::srv::FullNameSumService_Event::_info_type arg)
  {
...
template<>
inline
auto build<::full_name_interfaces::srv::FullNameSumService_Event>()
{
  return full_name_interfaces::srv::builder::Init_FullNameSumService_Event_info();
}
