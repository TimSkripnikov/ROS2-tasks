...
static const _FullNameSumService_Event_type_support_symbol_names_t _FullNameSumService_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, full_name_interfaces, srv, FullNameSumService_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, full_name_interfaces, srv, FullNameSumService_Event)),
  }
};
...
{
  return &::full_name_interfaces::srv::rosidl_typesupport_cpp::FullNameSumService_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, full_name_interfaces, srv, FullNameSumService_Event)() {
  return get_message_type_support_handle<full_name_interfaces::srv::FullNameSumService_Event>();
}
...
static const rosidl_service_type_support_t FullNameSumService_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<full_name_interfaces::srv::FullNameSumService_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<full_name_interfaces::srv::FullNameSumService_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<full_name_interfaces::srv::FullNameSumService_Event>(),
