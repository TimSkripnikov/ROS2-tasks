...
[[deprecated("use full_name_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const full_name_interfaces::srv::FullNameSumService_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  full_name_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use full_name_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const full_name_interfaces::srv::FullNameSumService_Event & msg)
{
  return full_name_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<full_name_interfaces::srv::FullNameSumService_Event>()
{
  return "full_name_interfaces::srv::FullNameSumService_Event";
}

template<>
inline const char * name<full_name_interfaces::srv::FullNameSumService_Event>()
{
  return "full_name_interfaces/srv/FullNameSumService_Event";
}

template<>
struct has_fixed_size<full_name_interfaces::srv::FullNameSumService_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<full_name_interfaces::srv::FullNameSumService_Event>
  : std::integral_constant<bool, has_bounded_size<full_name_interfaces::srv::FullNameSumService_Request>::value && has_bounded_size<full_name_interfaces::srv::FullNameSumService_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<full_name_interfaces::srv::FullNameSumService_Event>
  : std::true_type {};
