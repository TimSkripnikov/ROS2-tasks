...
// IWYU pragma: private, include "full_name_interfaces/srv/full_name_sum_service.h"


#ifndef FULL_NAME_INTERFACES__SRV__DETAIL__FULL_NAME_SUM_SERVICE__FUNCTIONS_H_
#define FULL_NAME_INTERFACES__SRV__DETAIL__FULL_NAME_SUM_SERVICE__FUNCTIONS_H_
 ...
 * calls
 * full_name_interfaces__srv__FullNameSumService_Request__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
full_name_interfaces__srv__FullNameSumService_Request *
full_name_interfaces__srv__FullNameSumService_Request__create(void);

/// Destroy srv/FullNameSumService message.
/**
 * It calls
 * full_name_interfaces__srv__FullNameSumService_Request__fini()
 ...
 * full_name_interfaces__srv__FullNameSumService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * full_name_interfaces__srv__FullNameSumService_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * full_name_interfaces__srv__FullNameSumService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
full_name_interfaces__srv__FullNameSumService_Response *
full_name_interfaces__srv__FullNameSumService_Response__create(void);

/// Destroy srv/FullNameSumService message.
/**
 * It calls
 * full_name_interfaces__srv__FullNameSumService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
...
/**
 * It allocates the memory for the array and calls
 * full_name_interfaces__srv__FullNameSumService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
...
/**
 * It calls
 * full_name_interfaces__srv__FullNameSumService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * Fields without a default value will not be initialized by this function.
 * You might want to call memset(msg, 0, sizeof(
 * full_name_interfaces__srv__FullNameSumService_Event
 * )) before or use
 * full_name_interfaces__srv__FullNameSumService_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
bool
full_name_interfaces__srv__FullNameSumService_Event__init(full_name_interfaces__srv__FullNameSumService_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
void
full_name_interfaces__srv__FullNameSumService_Event__fini(full_name_interfaces__srv__FullNameSumService_Event * msg);

/// Create srv/FullNameSumService message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * full_name_interfaces__srv__FullNameSumService_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
full_name_interfaces__srv__FullNameSumService_Event *
full_name_interfaces__srv__FullNameSumService_Event__create(void);

/// Destroy srv/FullNameSumService message.
/**
 * It calls
 * full_name_interfaces__srv__FullNameSumService_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
void
full_name_interfaces__srv__FullNameSumService_Event__destroy(full_name_interfaces__srv__FullNameSumService_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
bool
full_name_interfaces__srv__FullNameSumService_Event__are_equal(const full_name_interfaces__srv__FullNameSumService_Event * lhs, const full_name_interfaces__srv__FullNameSumService_Event * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
bool
full_name_interfaces__srv__FullNameSumService_Event__copy(
  const full_name_interfaces__srv__FullNameSumService_Event * input,
  full_name_interfaces__srv__FullNameSumService_Event * output);
...
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
bool
full_name_interfaces__srv__FullNameSumService_Event__Sequence__init(full_name_interfaces__srv__FullNameSumService_Event__Sequence * array, size_t size);
...
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
void
full_name_interfaces__srv__FullNameSumService_Event__Sequence__fini(full_name_interfaces__srv__FullNameSumService_Event__Sequence * array);

/// Create array of srv/FullNameSumService messages.
/**
 * It allocates the memory for the array and calls
 * full_name_interfaces__srv__FullNameSumService_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
full_name_interfaces__srv__FullNameSumService_Event__Sequence *
full_name_interfaces__srv__FullNameSumService_Event__Sequence__create(size_t size);

/// Destroy array of srv/FullNameSumService messages.
/**
 * It calls
 * full_name_interfaces__srv__FullNameSumService_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
void
full_name_interfaces__srv__FullNameSumService_Event__Sequence__destroy(full_name_interfaces__srv__FullNameSumService_Event__Sequence * array);
...
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
bool
full_name_interfaces__srv__FullNameSumService_Event__Sequence__are_equal(const full_name_interfaces__srv__FullNameSumService_Event__Sequence * lhs, const full_name_interfaces__srv__FullNameSumService_Event__Sequence * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_full_name_interfaces
bool
full_name_interfaces__srv__FullNameSumService_Event__Sequence__copy(
  const full_name_interfaces__srv__FullNameSumService_Event__Sequence * input,
  full_name_interfaces__srv__FullNameSumService_Event__Sequence * output);
#ifdef __cplusplus
}
#endif

#endif  // FULL_NAME_INTERFACES__SRV__DETAIL__FULL_NAME_SUM_SERVICE__FUNCTIONS_H_
