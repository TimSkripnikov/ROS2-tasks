...
bool current_target_message__msg__current_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("current_target_message.msg._current_target.CurrentTarget", full_classname_dest, 56) == 0);
  }
  current_target_message__msg__CurrentTarget * ros_message = _ros_message;
  {  // target_name
...
PyObject * current_target_message__msg__current_target__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("current_target_message.msg._current_target");
